 ...
 * Use the {@link fr_nhanvien#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fr_nhanvien extends Fragment {
    public static int position=0;
    NhanVienDAO nhanVienDAO;
    Button back;
    public static ListView lstnv;
    ArrayList<NhanVien> ls = new ArrayList<>();
    NhanVien nhanvien = new NhanVien();
    Adapter_NhanVien nhanVienadpter;
     ...
     * @return A new instance of fragment fr_nhanvien.
     */
    // TODO: Rename and change types and number of parameters
    public static fr_nhanvien newInstance(String param1, String param2) {
        fr_nhanvien fragment = new fr_nhanvien();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fr_nhanvien, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ls = nhanVienDAO.getDSSP();
        nhanVienadpter = new Adapter_NhanVien(getContext(),ls);
        lstnv.setAdapter(nhanVienadpter);
    }
    ...
    public void thamchieu(View v){
        lstnv = v.findViewById(R.id.lsv);
    }
}